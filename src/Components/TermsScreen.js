...
function TermsScreen(){
    return(
        <div className="container" style={{fontFamily: "Montserrat"}}>
            ...
            <ul >
                <h5 style={{color:"white"}}>A. GENERAL TERMS</h5>
                <li className="">
                    <p>
                ...
                <li>
                    <p>
                        M/s. Luit Entertainment (hereinafter referred to as “Company”, “We”, “Us” or “Our”) is a company registered partnership firm which provides for and facilitates through their online portal www.luit.co.in and offline platforms such as Android TV application, Amazon fire stick, Roku, Apple TV application (hereinafter referred to as “Platform”) and a mobile application (hereinafter referred to as “Mobile App”) distributing, broadcasting and streaming of motion pictures, both fictional and non-fictional, through electronic and digital media (hereinafter “Services”) to the customers (hereinafter “Customers”, “Users”, “You”, “Your”): The various Services offered through the Platform and the Mobile App include the following:
                    </p>
                </li>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>B. GENERAL REGISTRATION REQUIREMENTS</h5>
                <li>
                ...
                <h5 style={{color:"white"}}>C. SUBSCRIBER ACCOUNT, PASSWORD AND SECURITY</h5>
                <li>
                <p> You are solely responsible for maintaining the confidentiality of Your password and Account information and for all the other allied activities that may occur under Your Account. You agree to:</p>
                ...
                <h5 style={{color:"white"}}>D. THE COMPANY AND THE THIRD PARTIES</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>E. THIRD PARTY WEBSITES</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>F. ERRORS AND INACCURACIES</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>G. FEES FOR SERVICES PROVIDED</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>H. PAYMENT OF FEES</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>I. LIMITED RIGHT OF USE AND OWNERSHIP OF CONTENTS</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>J. COMPATIBLE SYSTEM</h5>
                <li>
                    <p>
                        The availability of the Content shall be solely dependent on the Your geographical location, the internet connectivity and the compatibility of the device being used to stream the Content. The Platform would work best on the latest and updated versions ofrelated software.
                    </p>
                </li>
                <h5 style={{color:"white"}}>K. AVAILABILITY OF SERVICES PROVIDED</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>L. CONSENT OF USERS</h5>
                <li>
                    <p>
                ...
                <li>
                    ...
                    <li className="sub-list">
                        f) be defamatory, libelous, abusive, threatening or harassing; 
                    </li>
                    <li className="sub-list">
                ...
                <h5 style={{color:"white"}}>M. PLATFORM CONTENT</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>N. INDEMNITY</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>O. RESTRICTIONS ON USERS</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>P. CONFIDENTIALITY OF INFORMATION</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>Q. DISCLAIMERS AND WARRANTIES</h5>
                <li>
                    <p>
                ...
                <h5 style={{color:"white"}}>R. TERMINATION OF SERVICES</h5>
                <li>
                    <p>
