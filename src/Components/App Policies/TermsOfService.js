	...
	render()
	{
		return(
			<div className="col-sm-12" style={{backgroundColor: "black"}}>
				...
				C. SUBSCRIBER ACCOUNT, PASSWORD AND SECURITY
				...
				D. THE COMPANY AND THE THIRD PARTIES
				...
				I. LIMITED RIGHT OF USE AND OWNERSHIP OF CONTENTS
